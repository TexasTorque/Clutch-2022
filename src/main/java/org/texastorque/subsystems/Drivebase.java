...
public final class Drivebase extends TorqueSubsystem implements Subsystems {
    ...
    private boolean shouldTarget = false, zeroWheels;

    public final void setShouldTarget(final boolean shouldTarget) {
    ...
    public void setZeroWheels(boolean zeroWheels) {
    ...
    private final TorqueSwerveModule2021 buildSwerveModule(final int id, final int drivePort, final int rotatePort) {
        final TorqueSwerveModule2021 m = new TorqueSwerveModule2021(id, drivePort, rotatePort, DRIVE_GEARING,
                DRIVE_WHEEL_RADIUS, DRIVE_PID,
