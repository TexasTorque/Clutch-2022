...
public class TCS34725ColorSensor {
    ...
    @SuppressWarnings("unused")
	    ...
	    private static final int TCS34725_ENABLE_AEN = // I CHANGED THIS FROM 0x02 to 0x01
	            (0x01); /* RGBC Enable - Writing 1 actives the ADC, 0 disables it */
	    ...
	    private static final int TCS34725_ID =
	            (0x44); /* 0x44 = TCS34721/TCS34725, 0x4D = TCS34723/TCS34727 */
