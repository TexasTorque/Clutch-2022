...
public class FiveLame extends TorqueSequence implements Subsystems {
    public FiveLame() {
        ...
        addBlock(new TorqueBlock(new Path("Five1_", true, 4, 4)));
        ...
        addBlock(new TorqueBlock(new Path("Five2_", false, 4, 2)));
